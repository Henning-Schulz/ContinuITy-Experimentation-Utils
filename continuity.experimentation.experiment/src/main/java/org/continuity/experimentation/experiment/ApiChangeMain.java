...
public class ApiChangeMain {
	...
	public static void main(String[] args) throws AbortException {
		...
		IDataHolder<String> versionStringHolder = CountingDataHolder.of("v").withStartValue(9);
		...
		Experiment.newExperiment("ASE-18-api").loop(1) //
				...
				.append(new DataInvalidation(versionStringHolder, markovChainHolder, referenceTestplanHolder, recordingStartTimeHolder, recordingStopTimeHolder, measurementDataLink,
						workloadLinkNoAnn, workloadLinkWithAnn, systemReportHolder, annotationReportHolder, tagForNoAnnGeneration))
